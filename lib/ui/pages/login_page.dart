import 'package:firebase_login_tatos7/blocs/login/login_bloc.dart';
import 'package:firebase_login_tatos7/blocs/login/login_state.dart';
import 'package:firebase_login_tatos7/blocs/login/login_event.dart';
...
import 'package:firebase_login_tatos7/ui/pages/signup_page.dart';
...
class LoginPageParent extends StatelessWidget {
  ...
  LoginPageParent({@required this.userRepository, @required this.user});
